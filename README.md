# test-task-tweets
https://salamandero.github.io/test-task-tweets/

Мета: створити картки твітів та додати інтерактивності при клікові на кнопку.

Стек технологій при виконанні тестового завдання:
- axios
- prop-types
- react
- react-dom
...
Макет: https://www.figma.com/file/zun1oP6NmS2Lmgbcj6e1IG/Test?type=design&t=7bzZXufpvBBQh2V9-0
